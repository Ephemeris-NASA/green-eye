...
pretrained_weights_path = './temp_model_cpu.pt'
# Load weights onto CPU and save to a temporary file
# weights = torch.load(pretrained_weights_path, map_location=torch.device('cpu'))
# temp_weights_path = './temp_model_cpu.pt'
# torch.save(weights, temp_weights_path)

# Update the pretrained_weights_path
...
loss_weights_multi = [1.7086634166666668, 0.661126]
...
experiment = 'green-eye-0.0.1'
project_dir = '../deforestation'
